...
def upgrade():
    ...
    sa.PrimaryKeyConstraint('id'),
    sa.UniqueConstraint('code', name='oauth2_code_code_unique')
    )
    ...
    sa.PrimaryKeyConstraint('id'),
    sa.UniqueConstraint('access_token', name='oauth2_code_access_token_unique')
    )
    ...
    op.create_unique_constraint(table_name='users', constraint_name='users_email_unique', columns=['email'])
    # ### end Alembic commands ###


def downgrade():
    # ### commands auto generated by Alembic - please adjust! ###
    op.drop_constraint(table_name='users', constraint_name='users_email_unique', type_='unique')
